...
|:---:|
|<span style="color: DodgerBlue; font-size: 40px;">June, 2024</span>|
 | **Nathan Hayford**(KTH, Sweden) <br /> ***Geometry of Grassmannians and Integrable Equations*** <br /> Zoom ID: 4323410132  <br /> <span style="color: Tomato; font-size: 25px;">4pm-5pm , June, 12th, 2024</span><br /> <button class="collapsible">Abstract</button> <div class="content"> <p>The discovery of the integrability of the KdV equation in the late 1960s ushered in a wave of new mathematics. Many new integrable equations were found, and soon entire hierarchies of integrable equations appeared. Subsequently, several authors provided characterizations of these hierarchies: the pseudodifferential calculus of Gelfand and Dickey, the dressing method of Sato, the bilinear method of Hirota, and so on. One of the most intriguing representations of these hierarchies came in the early 1980s from the Kyoto school. They characterized these equations as being encoded in the Plucker relations defining an infinite-dimensional Grassmannian, which shed light on the deep connection of integrable equations and geometry. In this talk, I will provide a more detailed account of this story, and explain how their characterization unified many of the facets of integrable hierarchies. After the talk, there will be six lectures given by Nathan on June 17,18,19. <table style="width:100%">
  <tr>
  ...
  <tr>
    <td>June 17, 9:30am-11:30am</td>
    <td>Lecture 1 and 2</td>
    <td>Lecture 1: The KdV hierarchy: Pseudodifferential calculus, Lenard recursion; Lecture 2: The KP hierarchy: Sato's dressing method</td>
  </tr>
  <tr>
    <td>June 18, 14:00pm-16:00pm</td>
    <td>Lecture 3 and 4</td>
    <td> Lecture 3: The KP hierarchy: Hirota bilinear method and vertex operators; Lecture 4: The Sato Grassmannian: Fock representation of Bosons/Fermions</td>
  </tr>
  <tr>
    <td>June 19, 14:00pm-16:00pm</td>
    <td>Lecture 5 and 6</td>
    <td>Lecture 5: The Sato Grassmannian: the Boson-Fermion correspondence; Lecture 6: The Sato Grassmannian: Plucker relations as Hirota equations</td>
  </tr>
</table></p></div> |
 |<span style="color: DodgerBlue; font-size: 40px;">April, 2024</span>|
 | **Seongjae Park**(Seoul National University, Korea) <br /> ***Large gap probabilities of complex and symplectic spherical ensembles with point charges*** <br /> Zoom ID: 4323410132  <br /> <span style="color: Tomato; font-size: 25px;">4pm-5pm , June, 17th, 2024</span><br /> <button class="collapsible">Abstract</button> <div class="content"> <p>The calculation of the asymptotics of the probability that there are no particles in a certain gap, known as the gap probability, is an important problem in point processes. In this talk, I will present the asymptotic expansion of the gap probabilities of complex and symplectic induced spherical ensembles, which can be realized as determinantal and Pfaffian 2D Coulomb gases on the Riemann sphere with the insertion of point charges. More precisely, when the gap is a spherical cap around the poles, we show that the gap probability has an asymptotic behavior of the form `$$\exp(C_1n^2 + C_2n\log n + C_3n + C_4\sqrt{n} + C_5\log n+ C_6 + o(1)). $$`Our proof relies on the uniform asymptotics of the incomplete beta function. This is based on joint work with Sung-Soo Byun.  </p></div> |
 |<span style="color: DodgerBlue; font-size: 40px;">April, 2024</span>|
 | **Seong-Mi Seo**(Chungnam National University, Korea) <br /> ***Boundary conditions on 2D Coulomb gas ensembles*** <br /> Zoom ID: 4323410132  <br /> <span style="color: Tomato; font-size: 25px;">4pm-5pm , April 26th, 2024</span><br /> <button class="collapsible">Abstract</button> <div class="content"> <p>Particles interacting via Coulomb interactions in an external field tend to condensate on a droplet as the number of particles increases. In this talk, I will discuss the boundary conditions that can be imposed on the boundaries of the droplets. While the free boundary condition allows particles to distribute outside the droplet, the hard edge condition forces particles to reside within a specific set, which leads to changes in the equilibrium density or the local statistics at the boundary. I will explain recent results on 2D Coulomb gas ensembles with hard edge boundary conditions.  </p></div> |
